...
public class BoardDaoImpl implements BoardDao {
	...
	public List<Board> read() {
		// DataSource에서 connection을 가져와서 SELECT 문장을 실행하고 결과를 리턴.
	...
	public Board read(int bno) {
		System.out.println("boardDaoImpl.read(" + bno + ") 메서드 호출");
