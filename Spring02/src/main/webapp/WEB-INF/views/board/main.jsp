		...
		<div class="container-fluid">
			...
			<nav> <!-- 메뉴 -->
				...
				<c:if test="${empty signInUserId}">
					<li class="nav-item">
						<a href="../user/signin" id="menu-login" type="button" class="btn btn-secondary">로그인</a>
					</li>
				</c:if>
				<c:if test="${not empty signInUserId}">
					<li class="nav-item"> <span>${signInUserId}</span>
						<a href="../user/signout" type="button" class="btn btn-secondary">로그아웃</a>
					</li>
				</c:if>
					<li class="nav-item">
						<a href="../" type="button" class="btn btn-secondary">메인</a>
					</li>
					<li class="nav-item">
						<a href="./insert" type="button" class="btn btn-secondary">새 글 작성</a>
					</li>
				</ul>
			</nav>
