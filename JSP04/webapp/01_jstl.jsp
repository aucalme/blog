...
<%--
JSTL 사용 방법:
1. tomcat.apache.org 사이트의 Taglibs 다운로드 페이지에서 
	(1) taglibs-standard-impl-1.2.5.jar
	(2) taglibs-standard-sepc-1.2.5.jar
	파일들을 다운로드 하고, project/webapp/WEB-INF/lib 폴더에 복사.
...
<html>
	...
	<body>
		...
		<% request.setAttribute("속성 이름", 속성값); %>
		--%>
		<h3>
