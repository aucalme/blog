...
// DAO(Date Access Object): Controller. 프로그램의 주된 기능(비즈니스 로직).
public interface MemberDao {
	 ...
	 * 
	 * @return - null이 아닌 값(Member 객체)이 있는 배열을 생성해서 리턴.
	 */
	Member[] select();
	
	/**
	 * 인덱스를 이용한 검색 기능: 검색한 인덱스를 전달 받아서, 배열에서 해당 인덱스의 Member 객체를 반환.
	 * 
